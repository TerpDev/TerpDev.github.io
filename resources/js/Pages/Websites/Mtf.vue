    ...
    <div class="bg-gray-900 py-24 sm:py-32">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="mx-auto max-w-2xl lg:mx-0 lg:max-w-none">
                <p class="text-5xl text-center pt-10 font-bold leading-7 pb-10 text-indigo-500">MTF-Automobielen</p>
                <div
        ...
        <div class="grid md:grid-cols-2 grid-cols-1 mx-auto max-w-7xl px-6 lg:px-8 gap-4 pt-10">
            <div>
                <Image src="/img/mtf/HeroMtf.png" alt="Image" preview/>
            </div>
            <div>
                <Image src="/img/mtf/PerfecteMtf.png" alt="Image" preview/>
            </div>
            <div>
                <Image src="/img/mtf/ExtraMtf.png" alt="Image" preview/>
            </div>
        </div>
    </div>
</template>
