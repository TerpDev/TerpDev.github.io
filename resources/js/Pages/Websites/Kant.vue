    ...
    <div class="bg-gray-900 py-24 sm:py-32">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="mx-auto max-w-2xl lg:mx-0 lg:max-w-none">
                <p class="text-5xl text-center pt-10 font-bold leading-7 pb-10 text-indigo-500">Kant Advocatuur</p>
                <div
                    class="mt-10 grid max-w-xl grid-cols-1 gap-8 text-base leading-7 text-gray-50 lg:max-w-none lg:grid-cols-2">
                    <div>
        ...
        <div class="grid md:grid-cols-2 grid-cols-1 mx-auto max-w-7xl px-6 lg:px-8 gap-4 pt-10">
            <div>
                <Image src="/img/kant/HeroKant.png" alt="Image" preview/>
            </div>
            <div>
                <Image src="/img/kant/KantSwiper.png" alt="Image" preview/>
            </div>
            <div>
                <Image src="/img/kant/Faqkant.png" alt="Image" preview/>
            </div>
            <div>
                <Image src="/img/kant/ContactKant.png" alt="Image" preview/>
            </div>
        </div>
    </div>
</template>
